            ...
            <div className=" w-96 p-6 bg-white rounded-lg ">
                ...
                <form className="form-control" onSubmit={handleSignUp}>
                    <input
                        ...
                        className="border-2 border-gray-700 rounded-lg  input input-bordered w-full mb-4"
                    />
                    <label className="border-2 border-gray-700 rounded-lg input mb-4 input-bordered flex items-center gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <select
                            ...
                            className="border-2 border-gray-700 rounded-lg  w-full px-4 py-2 mt-2 border rounded-md focus:ring-2 focus:ring-blue-500"
                        >
